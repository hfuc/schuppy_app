...
const Aothun = () => {
    ...
    const getList = () => {
        return fetch('https://637f779c2f8f56e28e8d058e.mockapi.io/ao_thun')
        ...
        <View style={styles.container}>
            <View style={{flexDirection:'row'}}>
                <Image
                    ...
                    source={require('../img/aothun.png')}
                    resizeMode="contain"
                />
                <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#00ab90',paddingTop:55 }}>Áo Thun</Text>
            </View>
