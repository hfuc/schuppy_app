...
const Quanshort = () => {
    ...
    const getList = () => {
        return fetch('https://637f918e5b1cc8d6f94999a0.mockapi.io/quan_short')
        ...
        <View style={styles.container}>
            <View style={{flexDirection:'row'}}>
                <Image
                    ...
                    source={require('../img/quanshort.jpg')}
                    resizeMode="contain"
                />
                <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#00ab90',paddingTop:55 }}>Quần Short</Text>
            </View>
