...
const Quandai = () => {
    ...
    const getList = () => {
        return fetch('https://637f779c2f8f56e28e8d058e.mockapi.io/quan_dai')
        ...
        <View style={styles.container}>
            <View style={{flexDirection:'row'}}>
                <Image
                    ...
                    source={require('../img/quandai.jpg')}
                    resizeMode="contain"
                />
                <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#00ab90',paddingTop:55 }}>Quần dài</Text>
            </View>
