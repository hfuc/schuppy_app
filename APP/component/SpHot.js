...
const SpHot = () => {
    ...
    const getList = () => {
        return fetch('https://637f918e5b1cc8d6f94999a0.mockapi.io/sp_hot')
        ...
        <View style={styles.container}>
            <View style={{flexDirection:'row'}}>
                {/* <Image
                    ...
                    source={require('../img/aopolo.png')}
                    resizeMode="contain"
                /> */}
                <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#6699FF',paddingTop:55,paddingLeft:120}}>Sản phẩm hot</Text>
            </View>
